    ...
    >
      ...
      <div>
        <input
          ...
          className="mb-4 w-full rounded-sm border border-stroke bg-[#f8f8f8] py-3 px-6 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="mb-5 flex w-full items-center justify-center rounded-sm bg-primary py-4 px-9 text-base font-medium text-white shadow-submit hover:bg-primary/90 dark:shadow-submit-dark cursor-pointer duration-300"
        />
